...
srun /home/x_cili/.conda/envs/lassie/bin/python train2.py --W_shape_prior 0.01 --W_kp_img 0.001 --W_pose_img 0.01 --W_mask_img 0.0001 \
                                                        --name TEST \
                                                        ...
                                                        --useSynData --useinterval 8 --max-epochs 800  --TEXT \
